...
namespace UnityEngine.Recorder.Examples
{
    ...
    public class MovieRecorderExample : MonoBehaviour
    {
        ...
        public void StartVideoRecording(string videoName)
        {
            Initialize(videoName);    
        }

        internal void Initialize(string videoName)
        {
            ...
            m_Settings.OutputFile = mediaOutputFolder.FullName + "/" + videoName;
